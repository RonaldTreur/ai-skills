---
name: solana-dev
description: Use for Solana dapps, wallets, tokens, Anchor/Pinocchio programs, devnet deploys, client generation, LiteSVM/Mollusk/Surfpool tests, debugging, and protocol concepts.
user-invocable: true
license: MIT
